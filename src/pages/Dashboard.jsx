        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-semibold text-gray-900">MERN Auth</h1>
            </div>
                ...
                <div className="flex items-center">
                  {user?.googleId ? (
                    <>
                      ...
                      <span className="text-lg text-gray-900">Google OAuth</span>
                    </>
                  ) : (
                    <>
                      ...
                      <span className="text-lg text-gray-900">Email & Password</span>
                    </>
                  )}
                </div>
              </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div className="text-center">
              ...
              <p className="text-gray-600">JWT-based authentication with refresh token rotation for maximum security.</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div className="text-center">
              ...
              <p className="text-gray-600">Automated email verification system with beautiful, responsive email templates.</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div className="text-center">
              ...
              <p className="text-gray-600">Seamless integration with Google OAuth for quick and secure social authentication.</p>
            </div>
          </div>
        </div>
      </main>
